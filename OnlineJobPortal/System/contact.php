...
<head>
	...
	<title>Jobby Jobs - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Jobby Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>First Floor, HIG B-14, Housing Board Colony, Mankapur Ring Rd, Trimurtee Nagar <br/> Nagpur, Maharashtra 440022 <br/>India</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:khushbooninawe24@gmail.com">khushbooninawe24@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 9665560085">+91 9665560085</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Jobby Portal</h5>
											<p>Jobby Poratal is a job portal, online job management system developed by Khushboo Ninawe for his project in April 2024.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address :First Floor, HIG B-14, Housing Board Colony, Mankapur Ring Rd, Trimurtee Nagar <br/> Nagpur, Maharashtra 440022 <br/>India</address></p>
								<p>Email : <a href="mailto:khushbooninawe24@gmail.com">khushbooninawe24@gmail.com</a></p>
								<p>Phone : <a href="tel:+91 9665560085">+91 9665560085</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> RG-VP Web Solutions</p>
