...
try {
	...
	if ($stmt->execute()) {
        $result = $stmt->fetchAll();
        $rec = count($result); // Count the number of results
    } else {
        // Handle the case where the query execution failed
        // For example, you can log the error or redirect the user
...
<head>
	...
	<title>Jobby Jobs - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
